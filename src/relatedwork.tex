...
stream-fusion~\cite{Shaikhha2018:LoopFusion} needs to define extra
fusion-related constructs.
...
We have a different fusion strategy, instead we provide a systematic
approach which collects precise shape information on a well-defined array-based
language for automatic fusion.}

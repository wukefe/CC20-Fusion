...
%In this section, we present the principles of loop fusion techniques for array-based optimization, and then provide background on HorseIR and its optimization capabilities. 
...
Ideally, a smart compiler can optimize loops as follows:
...
%\subsection{An Example} %Fusion for HorseIR Functions}





% \subsection{Type and Shape}
% \todo{introduce type and shape in HorseIR}
